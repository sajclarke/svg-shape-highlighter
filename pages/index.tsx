...
export default function Home() {
	const [clickedText, setText] = useState<string | null>(null);
	const [highlightArea, setArea] = useState<string | null>(null);

	const highlightColor = '#ff7d16';
	...
	return (
		<div className="mt-10">
			<div className="mx-auto h-auto rounded-md max-w-5xl flex">
				<div>
					<div className="human-body">
						...
						>
							<path
								fill={highlightArea === 'head' ? highlightColor : ''}
						...
						>
							<path
								fill={highlightArea === 'shoulder' ? highlightColor : ''}
						...
						>
							<path
								fill={highlightArea === 'arm' ? highlightColor : ''}
						...
						>
							<path
								fill={highlightArea === 'chest' ? highlightColor : ''}
						...
						>
							<path
								fill={highlightArea === 'stomach' ? highlightColor : ''}
						...
						>
							<path
								fill={highlightArea === 'legs' ? highlightColor : ''}
						...
						>
							<path
								fill={highlightArea === 'hands' ? highlightColor : ''}
				...
				<div>{clickedText && <p>You clicked on {clickedText}</p>}</div>
			</div>
			{clickedText && (
				<div>
					<button
